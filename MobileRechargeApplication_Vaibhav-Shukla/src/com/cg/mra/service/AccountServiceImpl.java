...
//class implementing AccountService class
public class AccountServiceImpl implements AccountService {
	...
	// get account details from DAO class and send to main class
	@Override
	...
	// get recharges amount from main class and send it to DAO class
	@Override
